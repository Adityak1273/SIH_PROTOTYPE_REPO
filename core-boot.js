...
function load(src,css){
 ...
 if(css&&!document.querySelector('link[data-ccner="'+css+'"]')){const l=document.createElement('link');l.rel='stylesheet';l.dataset.ccner=css;l.href='./'+css+'?v=0.20.4';document.head.appendChild(l)}
 const s=document.createElement('script');s.src='./'+src+'?v=0.20.4';s.defer=true;document.head.appendChild(s);
}
