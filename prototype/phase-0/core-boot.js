...
function loadAuth(){if(window.__CCNER_AUTH_LOADED)return;window.__CCNER_AUTH_LOADED=true;const css=document.createElement('link');css.rel='stylesheet';css.href='./level2-auth-v2.css?v=0.18.5';document.head.appendChild(css);const s=document.createElement('script');s.src='./level2-auth-v2.js?v=0.18.5';s.defer=true;document.head.appendChild(s)}
function loadSecurity(){if(window.__CCNER_SECURITY_LOADED)return;window.__CCNER_SECURITY_LOADED=true;const s=document.createElement('script');s.src='./security-center.js?v=0.18.5';s.defer=true;document.head.appendChild(s)}
...
function load(src,css){if(css){const l=document.createElement('link');l.rel='stylesheet';l.href='./'+css+'?v=0.18.5';document.head.appendChild(l)}const s=document.createElement('script');s.src='./'+src+'?v=0.18.5';s.defer=true;document.head.appendChild(s);return s}
...
function loadPhase8(){if(window.CCNER_PHASE8_LOADED)return;window.CCNER_PHASE8_LOADED=true;const s=document.createElement('script');s.src='./phase8.js?v=0.18.5';s.onload=()=>setTimeout(loadLevel4,0);s.defer=true;document.head.appendChild(s)}
...
setTimeout(loadAuth,0);setTimeout(loadSecurity,0);
})();
