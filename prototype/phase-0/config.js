...
(function(){
  ...
  addScript('phase2.js'); addScript('phase3.js'); addScript('phase4.js'); addScript('sequence-game.js'); addScript('sorting-game.js'); addScript('category-game.js'); addScript('pattern-game.js'); addScript('spot-difference-game.js');
})();
