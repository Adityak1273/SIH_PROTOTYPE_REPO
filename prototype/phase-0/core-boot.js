...
function loadAuth(){if(window.__CCNER_AUTH_LOADED)return;window.__CCNER_AUTH_LOADED=true;const css=document.createElement('link');css.rel='stylesheet';css.href='./level2-auth-v2.css?v=0.18.12';document.head.appendChild(css);const s=document.createElement('script');s.src='./level2-auth-v2.js?v=0.18.12';s.defer=true;document.head.appendChild(s)}
function loadSecurity(){if(window.__CCNER_SECURITY_LOADED)return;window.__CCNER_SECURITY_LOADED=true;const s=document.createElement('script');s.src='./security-center.js?v=0.18.12';s.defer=true;document.head.appendChild(s)}
function loadAdmin(){if(window.__CCNER_ADMIN_LOADED)return;window.__CCNER_ADMIN_LOADED=true;const css=document.createElement('link');css.rel='stylesheet';css.href='./admin-access.css?v=0.18.12';document.head.appendChild(css);const s=document.createElement('script');s.src='./admin-access.js?v=0.18.12';s.defer=true;document.head.appendChild(s)}
function loadAuthRecovery(){if(window.__CCNER_AUTH_RECOVERY_LOADED)return;window.__CCNER_AUTH_RECOVERY_LOADED=true;const s=document.createElement('script');s.src='./auth-recovery.js?v=0.18.12';s.defer=true;document.head.appendChild(s)}
...
function load(src,css){if(css){const l=document.createElement('link');l.rel='stylesheet';l.href='./'+css+'?v=0.18.12';document.head.appendChild(l)}const s=document.createElement('script');s.src='./'+src+'?v=0.18.12';s.defer=true;document.head.appendChild(s);return s}
...
function loadPhase8(){if(window.CCNER_PHASE8_LOADED)return;window.CCNER_PHASE8_LOADED=true;const s=document.createElement('script');s.src='./phase8.js?v=0.18.12';s.onload=()=>setTimeout(loadLevel4,0);s.defer=true;document.head.appendChild(s)}
function loadAdaptive(){if(window.CCNER_ADAPTIVE_GAME_ENGINE_REQUESTED)return;window.CCNER_ADAPTIVE_GAME_ENGINE_REQUESTED=true;const s=load('game-engine-adaptive.js');s.onload=()=>load('game-engine-adaptive-v5.js');}
function load567(){if(window.CCNER_567_LOADED)return;window.CCNER_567_LOADED=true;load('level567-core.js','level567-core.css');const s=document.createElement('script');s.src='./hide-daily-routine.js?v=0.18.12';s.defer=true;document.head.appendChild(s)}
