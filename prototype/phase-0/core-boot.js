...
function load(src,css){if(css){const l=document.createElement('link');l.rel='stylesheet';l.href='./'+css+'?v=0.18.3';document.head.appendChild(l)}const s=document.createElement('script');s.src='./'+src+'?v=0.18.3';s.defer=true;document.head.appendChild(s);return s}
...
function loadPhase8(){if(window.CCNER_PHASE8_LOADED)return;window.CCNER_PHASE8_LOADED=true;const s=document.createElement('script');s.src='./phase8.js?v=0.18.3';s.onload=()=>setTimeout(loadLevel4,0);s.defer=true;document.head.appendChild(s)}
